			...
			<view class="back-top">
				...
				<view class="cu-list menu card-menu margin-top" v-if="TabCur==0">
					<block v-for="(item, index, key) in fishSpotData1" :key="key">
						...
						<view class="cu-item" @click="cardMenu($event)" :data-id="item.id" :data-fishtype="1" :data-fishname="item.title">
							<view class="content">
				...
				<view class="cu-list menu card-menu margin-top" v-if="TabCur==1">
					<block v-for="(item, index, key) in fishSpotData2" :key="key">
						...
						<view class="cu-item" @click="cardMenu($event)" :data-id="item.id" :data-fishtype="2">
							<view class="content">
				...
				<view class="cu-list menu card-menu margin-top" v-if="TabCur==2">
					<block v-for="(item, index, key) in fishSpotData3" :key="key">
						...
						<view class="cu-item" @click="cardMenu($event)" :data-id="item.id" :data-fishtype="3">
							<view class="content">
	...
	export default {
		data() {
			return {
				...
				// 野钓
				fishSpotData1: [
					{ title: '鱼点', value: '距离3km', label: '翘嘴，白条，鲢鱼，草鱼', way:['路亚', '台钓'], id:1},
					{ title: '鱼点', value: '距离3.2km', label: '白条，鲢鱼，草鱼', way:['海竿'], id:2},
					{ title: '鱼点', value: '距离3.2km', label: '白条，鲢鱼，草鱼，小龙虾', way:['路亚'], id:3},
					{ title: '鱼点', value: '距离3.3km', label: '小龙虾，鲫鱼，河虾', way:['路亚', '台钓'], id:4},
					{ title: '鱼点', value: '距离3.2km', label: '鲤鱼，鲫鱼，草鱼', way:['路亚'], id:5},
					{ title: '鱼点', value: '距离3.3km', label: '翘嘴，鲤鱼，鲫鱼，小龙虾', way:['路亚', '台钓'], id:6}
				],
				// 黑坑
				fishSpotData2: [
					{ title: '鱼点', value: '距离3km', label: '翘嘴，白条，鲢鱼，草鱼', way:['路亚', '台钓'], id:1},
					{ title: '鱼点', value: '距离3.2km', label: '小龙虾，鲫鱼，河虾', way:['海竿'], id:2},
					{ title: '鱼点', value: '距离3.3km', label: '翘嘴，鲤鱼，鲫鱼，小龙虾', way:['路亚', '台钓'], id:3},
					{ title: '鱼点', value: '距离3.2km', label: '鲤鱼，鲫鱼，草鱼', way:['路亚', '台钓'], id:4},
					{ title: '鱼点', value: '距离3.3km', label: '翘嘴，鲤鱼，鲫鱼，小龙虾', way:['路亚', '台钓'], id:5}
				],
				// 江边
				fishSpotData3: [
					{ title: '鱼点', value: '距离3km', label: '白条，鲢鱼，草鱼', way:['路亚', '台钓'], id:1},
					{ title: '鱼点', value: '距离3.3km', label: '翘嘴，白条，鲢鱼，草鱼', way:['海竿'], id:2},
					{ title: '鱼点', value: '距离3.2km', label: '鲤鱼，鲫鱼，草鱼', way:['路亚', '台钓'], id:3},
					{ title: '鱼点', value: '距离3.3km', label: '翘嘴，鲤鱼，鲫鱼，小龙虾', way:['路亚', '台钓'], id:4}
				],
				// 判断触底操作是否正在Loading中
